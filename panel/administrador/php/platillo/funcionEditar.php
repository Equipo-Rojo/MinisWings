<?php
	...
	$sql = "UPDATE platillo SET nombre='".$nombre."', categoria='".$categoria."', descripcion='".$descipcion."',precio=".$precio.",Estado='activo' WHERE id_Plat=".$id;
	$con = $con->conectar();
	...
	$sql="DELETE FROM r_pl_in WHERE id_Plat=".$id;
    ...
    for($i=1;$i<=$cont;$i++)  
    {
        $sql="INSERT INTO r_pl_in (id_Plat,id_Inv,cant) VALUES (".$id.",".$_POST['id_Inv'.$i].",".$_POST['cant_'.$i].")";
        $result = $con->query($sql);
    }
    ...
    $ruta_final="../../../../img/platillo/platillo_".$id.".jpg";
